                            ...
                            feature: {
                                ...
                                dataView: {
                                    optionToContent: function (opt) {
                                        ...
                                        let tdHeads =
                                            '<th  style="padding: 0 20px">所在地区</th><th style="padding: 0 20px">人数</th>' //表头
                                        let tdBodys = '' //数据
                                        let table =
                              ...
                              <td style="padding: 0 50px">${series[i].value.toFixed(0)}人</td>
                              </tr>`
                                        }
                                        table += '</tbody></table>'
                                        return table
                        ...
                        geo: {
                            ...
                            tooltip: {
                                ...
                                formatter: (p) => {
                                    ...
                                    let txtCon =
                                        "<div style='text-align:left'>" + p.name + ":<br />人数：" + val.toFixed(
                                            0) + '人</div>';
                                    return txtCon;
                                }
                            },
